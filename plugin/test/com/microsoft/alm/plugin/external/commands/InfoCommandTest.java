...
public class InfoCommandTest extends AbstractCommandTest {
  ...
  public void testGetArgumentBuilder_withContext() {
    ...
    Assert.assertEquals(
        "info -noprompt -collection:http://server:8080/tfs/defaultcollection ******** file1 file2 file3",
        builder.toString());
  }
  ...
  public void testParseOutput_noErrors() {
    ...
    Assert.assertEquals("/path/to/HelloWorld.java",
                        infos.get(1).getLocalItem());
    Assert.assertEquals("$/TFVC_1/src/com/microsoft/demo/HelloWorld.java",
                        infos.get(1).getServerItem());
