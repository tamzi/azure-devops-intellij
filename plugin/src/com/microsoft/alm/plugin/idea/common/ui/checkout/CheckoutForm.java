...
public class CheckoutForm implements BasicForm, Disposable {
  ...
  @NonNls
  public static final String CMD_REPO_FILTER_CHANGED =
      "repositoryFilterChanged";
  @NonNls public static final String CMD_REFRESH = "refresh";
  @NonNls public static final String CMD_GOTO_TFS = "gotoTFS";
  @NonNls public static final String CMD_GOTO_SPS_PROFILE = "gotoSPSProfile";

  public CheckoutForm(final boolean vsoSelected,
                      final RepositoryContext.Type repositoryType) {
  ...
  private void ensureInitialized() {
    if (!initialized) {
      ...
      helpPanel.addPopupCommand(
          TfPluginBundle.message(TfPluginBundle.KEY_VSO_LOOKUP_HELP_ENTER_URL),
          CMD_GOTO_TFS);
      helpPanel.addPopupCommand(
          TfPluginBundle.message(
              TfPluginBundle.KEY_VSO_LOOKUP_HELP_VIEW_ACCOUNTS),
          CMD_GOTO_SPS_PROFILE);
      helpPanel.setVisible(
          false); // Don't show this help panel until we know if it's vs.com

      // Set hint text
      repositoryFilter.setUI(new HintTextFieldUI(TfPluginBundle.message(
          TfPluginBundle.KEY_CHECKOUT_DIALOG_FILTER_HINT)));

      // Setup folder browser
      parentDirectory.getInsets().right = 0;
      parentDirectory.addBrowseFolderListener(
          TfPluginBundle.message(
              TfPluginBundle.KEY_CHECKOUT_DIALOG_PARENT_FOLDER_DIALOG_TITLE),
          null, null,
          new FileChooserDescriptor(false, true, false, false, false, false));

      // Align the busy spinner with the height of the refresh button (has to be
      // the refresh button height so the image isn't squashed and then
      // disappears) Also change the refresh button width so that the button is
      // a perfect square
      final int refreshButtonHeight =
          (int)refreshButton.getMinimumSize().getHeight();
      final Dimension size =
          new Dimension(refreshButtonHeight, refreshButtonHeight);
      ...
      repositoryFilter.getDocument().addDocumentListener(
      ...
      repositoryTableScrollPane.setMinimumSize(
          new Dimension(JBUI.scale(200), JBUI.scale(70)));
      ...
      if (repositoryType == RepositoryContext.Type.TFVC) {
        ...
        advancedCheckBox.setText(TfPluginBundle.message(
            TfPluginBundle.KEY_CHECKOUT_DIALOG_TFVC_ADVANCED));

        serverWorkspaceCheckBox.setVisible(true);
        serverWorkspaceCheckBox.setText(TfPluginBundle.message(
            TfPluginBundle.KEY_CHECKOUT_DIALOG_TFVC_SERVER_WORKSPACE));
      } else {
  ...
  public String getRepositoryFilter() { return repositoryFilter.getText(); }

  public JComponent getPreferredFocusedComponent() { return repositoryFilter; }
  ...
  public JComponent getDirectoryNameComponent() { return directoryName; }
  ...
  public void setServerName(final String name) {
    ...
    if (!userAccountPanel.isWindowsAccount() ||
        UrlHelper.isTeamServicesUrl(name)) {
  ...
  public boolean isAdvanced() { return advancedCheckBox.isSelected(); }
  ...
  private void $$$setupUI$$$() {
    ...
    contentPanel.setLayout(
        new GridLayoutManager(10, 3, new Insets(0, 0, 0, 0), -1, -1));
    ...
    contentPanel.add(
        label1, new GridConstraints(1, 0, 1, 3, GridConstraints.ANCHOR_WEST,
    ...
    contentPanel.add(
        label2, new GridConstraints(5, 0, 1, 3, GridConstraints.ANCHOR_WEST,
                                    GridConstraints.FILL_NONE,
                                    GridConstraints.SIZEPOLICY_FIXED,
                                    GridConstraints.SIZEPOLICY_FIXED, null,
                                    null, null, 0, false));
    ...
    contentPanel.add(
        label3, new GridConstraints(7, 0, 1, 3, GridConstraints.ANCHOR_WEST,
                                    GridConstraints.FILL_NONE,
                                    GridConstraints.SIZEPOLICY_FIXED,
                                    GridConstraints.SIZEPOLICY_FIXED, null,
                                    null, null, 0, false));
    ...
    contentPanel.add(
        directoryName,
        new GridConstraints(8, 0, 1, 3, GridConstraints.ANCHOR_WEST,
                            GridConstraints.FILL_HORIZONTAL,
                            GridConstraints.SIZEPOLICY_WANT_GROW,
                            GridConstraints.SIZEPOLICY_FIXED, null,
                            new Dimension(150, -1), null, 0, false));
    contentPanel.add(
        userAccountPanel,
        new GridConstraints(0, 0, 1, 3, GridConstraints.ANCHOR_EAST,
                            GridConstraints.FILL_NONE,
    ...
    contentPanel.add(
        repositoryTableScrollPane,
        new GridConstraints(3, 0, 1, 3, GridConstraints.ANCHOR_CENTER,
    ...
    contentPanel.add(
        parentDirectory,
        new GridConstraints(6, 0, 1, 3, GridConstraints.ANCHOR_CENTER,
                            GridConstraints.FILL_HORIZONTAL,
                            GridConstraints.SIZEPOLICY_CAN_SHRINK |
                                GridConstraints.SIZEPOLICY_CAN_GROW,
                            GridConstraints.SIZEPOLICY_CAN_SHRINK |
    ...
    helpPanel.setPopupText(
        ResourceBundle.getBundle("com/microsoft/alm/plugin/idea/ui/tfplugin")
            .getString("VsoLookupHelp.Instructions"));
    contentPanel.add(
        helpPanel, new GridConstraints(4, 0, 1, 3, GridConstraints.ANCHOR_EAST,
                                       GridConstraints.FILL_NONE,
                                       GridConstraints.SIZEPOLICY_CAN_SHRINK |
                                           GridConstraints.SIZEPOLICY_CAN_GROW,
                                       GridConstraints.SIZEPOLICY_CAN_SHRINK |
    ...
    contentPanel.add(
        advancedCheckBox,
        new GridConstraints(
            9, 0, 1, 3, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE,
            GridConstraints.SIZEPOLICY_CAN_SHRINK |
                GridConstraints.SIZEPOLICY_CAN_GROW,
            GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    busySpinner = new BusySpinnerPanel();
    contentPanel.add(busySpinner, new GridConstraints(
                                      2, 1, 1, 1, GridConstraints.ANCHOR_CENTER,
                                      GridConstraints.FILL_NONE,
                                      GridConstraints.SIZEPOLICY_CAN_SHRINK |
                                          GridConstraints.SIZEPOLICY_CAN_GROW,
                                      GridConstraints.SIZEPOLICY_CAN_SHRINK |
    ...
    contentPanel.add(refreshButton,
                     new GridConstraints(2, 2, 1, 1,
                                         ...
                                         GridConstraints.FILL_HORIZONTAL, 1,
                                         GridConstraints.SIZEPOLICY_FIXED, null,
                                         null, null, 0, false));
  }
