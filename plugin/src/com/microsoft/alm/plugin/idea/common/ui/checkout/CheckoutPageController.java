...
/**
 * This class binds the UI with the Model by attaching listeners to both and
...
class CheckoutPageController extends AbstractController {
  ...
  public CheckoutPageController(final CheckoutController parentController,
                                final CheckoutPageModel model,
  ...
  public void update(final Observable o, final Object arg) {
    ...
    if (arg == null) {
      page.setRepositoryTable(model.getTableModel(),
                              model.getTableSelectionModel());
    }
  }
  ...
  public void actionPerformed(final ActionEvent e) {
    ...
    if (LoginForm.CMD_SIGN_IN.equals(e.getActionCommand())) {
      ...
      // Reload the table (the refresh button shouldn't be visible if the query
      ...
      model.signOut();
      super.requestFocus(page);
    } else if (CheckoutForm.CMD_REPO_FILTER_CHANGED.equals(
                   e.getActionCommand())) {
      // No action needed here. We updated the model above which should filter
