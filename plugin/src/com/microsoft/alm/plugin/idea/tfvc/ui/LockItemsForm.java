...
public class LockItemsForm {
  ...
  public LockItemsForm(List<ExtendedItemInfo> items) {
    ...
    for (int i = 0; i < LockItemsTableModel.Column.values().length; i++) {
      lockItemsTable.getColumnModel().getColumn(i).setPreferredWidth(
          LockItemsTableModel.Column.values()[i].getWidth());
    }
  ...
  public LockCommand.LockLevel getLockLevel() {
    if (lockCheckInRadioButton.isEnabled() &&
        lockCheckInRadioButton.isSelected()) {
      return LockCommand.LockLevel.CHECKIN;
    } else if (lockCheckOutRadioButton.isEnabled() &&
               lockCheckOutRadioButton.isSelected()) {
      return LockCommand.LockLevel.CHECKOUT;
    }
    return LockCommand.LockLevel.NONE;
  }

  public boolean getRecursive() { return recursiveCheckBox.isSelected(); }
  ...
  private void $$$setupUI$$$() {
    ...
    panel1.setBorder(BorderFactory.createTitledBorder(
        ...
        ResourceBundle.getBundle("com/microsoft/alm/plugin/idea/ui/tfplugin")
            .getString("LockDialog.LockBox")));
    lockCheckInRadioButton = new JRadioButton();
    this.$$$loadButtonText$$$(
        lockCheckInRadioButton,
        ResourceBundle.getBundle("com/microsoft/alm/plugin/idea/ui/tfplugin")
            .getString("LockDialog.CheckinRadio"));
    panel1.add(lockCheckInRadioButton,
    ...
    this.$$$loadButtonText$$$(
        lockCheckOutRadioButton,
        ResourceBundle.getBundle("com/microsoft/alm/plugin/idea/ui/tfplugin")
            .getString("LockDialog.CheckoutRadio"));
    panel1.add(lockCheckOutRadioButton,
    ...
    this.$$$loadButtonText$$$(
        recursiveCheckBox,
        ResourceBundle.getBundle("com/microsoft/alm/plugin/idea/ui/tfplugin")
            .getString("LockDialog.RecursiveCheck"));
    panel1.add(recursiveCheckBox,
