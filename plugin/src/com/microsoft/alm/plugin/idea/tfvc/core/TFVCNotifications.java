...
public class TFVCNotifications {
  ...
  private static MergingUpdateQueue ourQueue = new MergingUpdateQueue(
      "TFVCNotifications.myQueue", 2000, false, null, null, null, true);

  public static void
  showInvalidDollarFilePathNotification(@NotNull Project project,
    ...
    ourQueue.queue(new Update(Pair.create(project, serverFilePath)) {
      ...
      public void run() {
        ...
        notification.addAction(
            new AddFileToTfIgnoreAction(project, serverFilePath));
