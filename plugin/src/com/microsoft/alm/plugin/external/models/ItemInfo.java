...
public class ItemInfo {
  ...
  public ItemInfo(String serverItem, String localItem, String serverVersion,
                  String localVersion, String change, String type,
                  String lastModified, String fileType) {
  ...
  public static ItemInfo from(TfsItemInfo ii) {
    return new ItemInfo(ii.getServerItem(), ii.getLocalItem(),
                        Integer.toString(ii.getServerVersion()),
                        Integer.toString(ii.getLocalVersion()), ii.getChange(),
                        ii.getType(), ii.getLastModified(),
                        ii.getFileEncoding());
  }

  public String getServerItem() { return serverItem; }

  public String getLocalItem() { return localItem; }
