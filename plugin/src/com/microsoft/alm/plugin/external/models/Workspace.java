...
public class Workspace {
  ...
  public Workspace(final String server, final String name,
                   final String computer, final String owner,
  ...
  /**
   * @return the presentable string for server name (the URL without URL
   *     escaping applied). For example, URL
   * "http://tfs/collection%20name" will be presented here as
   * "http://tfs/collection name".
   */
  public String getServerDisplayName() { return server; }

  public URI getServerUri() { return UrlHelper.createUri(server); }
  ...
  /**
   * Compare only name, computer, owner, and server to see if it's the same
   * workspace The comment and mappings don't make the workspace unique
   *
   * @param object
   * @return
   */
  ...
  /**
   * This class is used by the Workspace commands when creating or updating a
   * workspace.
   */
  ...
  /**
   * This class represents a "working folder" in a workspace that maps a local
   * path to a server path.
   */
  public static class Mapping {
    ...
    public Mapping(final String serverPath, final String localPath,
  ...
  public enum Location {
    ...
    /**
     * Converts this enum member to a string suitable for use in a command-line
     * TFVC client.
     */
