 ...
 * com.microsoft.alm.plugin.external package. It implements the
 * LocalizedException interface to make sure the exceptions can be localized.
 */
public class ToolException
    extends RuntimeException implements LocalizedException {
  ...
  public static String KEY_TF_MIN_VERSION_WARNING =
      "KEY_TF_MIN_VERSION_WARNING";
  public static String KEY_TF_WORKSPACE_COULD_NOT_BE_DETERMINED =
      "KEY_TF_WORKSPACE_COULD_NOT_BE_DETERMINED";
  ...
  public static String KEY_TF_VS_MIN_VERSION_WARNING =
      "KEY_TF_VS_MIN_VERSION_WARNING";
}
